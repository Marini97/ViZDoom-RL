...
def train():
    ...
    SEED = 0
    actor_savefile = 'a2c/models/sweeps/basic/actor.pth'
    critic_savefile = 'a2c/models/sweeps/basic/critic.pth'
...
def main():
    sweep_id = wandb.sweep(sweep=sweep_configuration, project='vizdoom-a2c-basic')
