...
description = "health gathering con reward shaping"
dueling = True
...
config_file_path = "content/scenarios/health_gathering.cfg"
...
def run(game, agent, actions, num_epochs, frame_repeat, steps_per_epoch=2000):
    ...
    for epoch in range(num_epochs):
        game.new_episode()
        last_x = game.get_game_variable(vzd.GameVariable.USER2)
        last_y = game.get_game_variable(vzd.GameVariable.USER3)
        ...
        for _ in trange(steps_per_epoch, leave=False):
            ...
            x = game.get_game_variable(vzd.GameVariable.USER2)
            y = game.get_game_variable(vzd.GameVariable.USER3)
...
class DQNAgent:
    def __init__(self, action_size, memory_size, batch_size, discount_factor,
                 lr, load_model, epsilon=1, epsilon_decay=0.9996, epsilon_min=0.0):
