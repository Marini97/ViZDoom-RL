...
model_savefile = "content/basic/model-rgb.pth"
save_model = True
load_model = True
skip_learning = False

description = "input RGB"
dueling = True
...
stats_file_path = "content/basic/stats-rgb.json"

# Configuration file path
config_file_path = "content/scenarios/basic.cfg"
    ...
    for epoch in range(num_epochs):
        ...
        for _ in trange(steps_per_epoch, leave=False):
            ...
            if not done:
                ...
                next_state = np.zeros((3, 120, 160)).astype(np.float32)
            ...
            if (global_step + (2000 * epoch)) % 10000 == 0:
...
class DQNAgent:
    def __init__(self, action_size, memory_size, batch_size, discount_factor,
                 lr, load_model, epsilon=1, epsilon_decay=0.9996, epsilon_min=0.00):
...
if __name__ == '__main__':
    ...
    game.init()
    stats["info"]["net_descritpion"] = str(summary(agent.q_net, (3, 120, 160)))
